...
slug: en/reference/errors/E02-228
---
## Problem
...
For further information see [Attribute settings article](../../settings/attributes.html).

#### For Custom Entities
Go to Settings > Custom Entities.
For further information see [Custom entities settings article](../../settings/custom-entities.html).
