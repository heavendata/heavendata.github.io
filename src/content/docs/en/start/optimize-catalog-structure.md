...
The article [Attribute Settings](../settings/attributes.html) describes how to configure attributes and sections.
...
The article [Product Type Settings](../settings/product-types.html) describes how to configure product types. You'll find details how to configure variants in [Product Variants](../settings/product-variants.html).
...
The article [Common Attributes](../settings/attributes.html) describes how to configure common attributes.
